...
\newcommand{\KEVIN}[1]{\textcolor{blue}{\textbf{Kevin comment}:~#1}}
\newcommand{\ALEX}[1]{\textcolor{blue}{\textbf{Alex comment}:~#1}}
\newcommand{\JONATHAN}[1]{\textcolor{blue}{\textbf{JONATHAN comment}:~#1}}
\newcommand{\VIGNESH}[1]{\textcolor{blue}{\textbf{Vignesh comment}:~#1}}
