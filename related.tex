...
used attention for image-captioning and video-captioning resepectively.
...
However, in our work we use attention to identify the most releavant person to
the overall event during different phases of the event.\eat{We also provide a
better BLSTM based representation for the atteneded people as
