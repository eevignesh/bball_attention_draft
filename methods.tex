...
detector\cite{} \Jon{cite}, the appearance features were extracted by feeding the cropped
...
a bidirectional LSTM applied to the frame-level feature as shown in Fig.~\ref{fig:system_fig}. \Jon{figure}
...
Unlike past attention models \cite{},\Jon{cite} we need to attend to a different set of
